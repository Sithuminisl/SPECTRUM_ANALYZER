...
HD_PWD='D:/Projects/Spectrum Analyzer/High-Frequency-Spectrum-Analyzer/LowFrequencyIOProject/LowFrequencyIOProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_store.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adc_store.tcl -notrace
