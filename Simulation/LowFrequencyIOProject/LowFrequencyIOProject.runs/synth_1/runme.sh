...
HD_PWD='D:/Projects/Spectrum Analyzer/High-Frequency-Spectrum-Analyzer/LowFrequencyIOProject/LowFrequencyIOProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adc_store.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adc_store.tcl
